    ...
    function display($group=FALSE, $wrapper=FALSE){
        if(count($this->messages)){
            ...
            foreach($output as $type => $messages){
				echo '<div class="alert alert-'.$type.' fade in"><button class="close" aria-hidden="true" data-dismiss="alert" type="button"><i class="fa fa-times-circle" data-dismiss="alert"></i></button>
