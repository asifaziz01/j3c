...
<div class="row">
	...
	<div class="col-md-8 col-sm-12 no-padding">
		<div class="widget box">
			...
			<div class="widget-content">
				<form class="form-horizontal" action="<?php echo site_url("admin/user/edit_profile/".$profile['id']);?>" method="post" >
				<input type="hidden" value="" name="profile_pic" id="cropImg" />
				<div class="form-group">
					<div class="col-md-3">Email</div>
					<div class="col-md-9">
					<input type="email" name="email" class="form-control" value="<?php echo $profile['email'];?>" disabled placeholder="email" />
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">Name</div>
					<div class="col-md-9">
					<input type="text" name="uname" class="form-control" value="<?php echo $profile['name'];?>" placeholder="name" />
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">Father Name</div>
					<div class="col-md-9">
					<input type="text" name="father" class="form-control" value="<?php echo $profile['father'];?>" placeholder="Father" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="form-check" align="left">
						<label class="form-check-label" style="font-size:14px;">
							<input class="form-check-input" type="radio" name="gender" value="1" <?php echo ($profile['gender']==1)?'checked':'';?> > Male
						</label>&nbsp;&nbsp;&nbsp;&nbsp;
						<label class="form-check-label" style="font-size:14px;">
							<input class="form-check-input" type="radio" name="gender" value="2" <?php echo ($profile['gender']==2)?'checked':''; ?> > Female
						</label>
					</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-9">
					<input type="text" name="mobile" class="form-control" value="<?php echo $profile['phone'];?>" disabled placeholder="Mobile No" />
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">Address</div>
					<div class="col-md-9">
					<textarea name="address" class="form-control" value="" placeholder="Address" ><?php echo $profile['address'];?></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">Adhaar</div>
					<div class="col-md-9">
					<input type="text" name="adhaar" class="form-control" value="<?php echo $profile['adhaar'];?>" placeholder="Adhaar No" />
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">Pan</div>
					<div class="col-md-9">
					<input type="text" name="pan" class="form-control" value="<?php echo $profile['pan'];?>" placeholder="Pan No" />
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">GST NO.</div>
					<div class="col-md-9">
					<input type="text" name="gst" class="form-control" value="<?php echo $profile['gst'];?>" placeholder="GST No" />
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">Company Name</div>
					<div class="col-md-9">
					<input type="text" name="company" class="form-control" value="<?php echo $profile['company'];?>" placeholder="Company Name" />
					</div>
				</div>
				<div class="action-group">
					<div class="col-md-12"><br>
					<button type="submit" name="submit" class="btn btn-primary pull-right">Update Detail</button>
					</div>
				</div>
				<br clear="all" />
				</form>
