<div class="row">
	<div class="col-md-5">
    	<div class="block">
            <form id="form-validation" class="form-horizontal form-bordered" method="post" action="<?php echo site_url("admin/news/create_category");?>">
            
            <div class="form-group">
                <label class="control-label" for="val_username">Category Title 
                ...
                <table class="datatable table table-vcenter table-condensed table-bordered">
                    ...
                    if($results){
                        foreach($results as $result){
                            echo '<tr>';
                                echo '<td>'.html_entity_decode($result['title']).'</td>';
                                echo '<td>';
