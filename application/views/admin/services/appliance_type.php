<div class="row">
  <div class="col-md-6 col-sm-12 col-xs-12">
      <div class="widget box">
        ...
        <div class="widget-content">
          <?php echo form_open_multipart ('admin/services/appliance_type/'.$tid.'/'.$appid, array ('class'=>'form-horizontal')); ?>
          ...
          <div class="form-group">
            <label  class="col-md-4 col-sm-12 col-xs-12">Appliance Type</label>
            <div class="col-md-8 col-sm-12 col-xs-12">
              <input type="text" name="type" class="form-control" value="<?php echo ($type)?$type['type_name']:'';?>">
            </div>
          </div>
          <div class="form-actions">
              <a class="btn btn-danger" href="<?php echo site_url('admin/services/appliances');?>" >Cancel</a>
              <input type="submit" class="btn btn-primary pull-right"  name="submit" value="<?php echo ($tid)?'Update':'Create New';?>">
          </div>
          <?php echo form_close (); ?>
        </div>
      </div>
  ...
  <?php
  $alltypes = $this->appliance_m->get_appliance_types();
  ?>
  <div class="col-md-6 col-sm-12 col-xs-12">
    <div class="widget box">
      <div class="widget-content">
        <table  class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
          ...
          if($alltypes){
            foreach($alltypes as $type){
              $app = $this->appliance_m->get_appliance($type['appliance_id']);
              ...
              echo '<td><a href="'.site_url('admin/services/appliance_type/'.$type['type_id'].'/'.$type['appliance_id']).'" class="btn btn-xs btn-success"><i class="icon-pencil"></i></a></td>';
              echo '</tr>';
            }
          }
          ?>
