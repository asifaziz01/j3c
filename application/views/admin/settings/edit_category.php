<div class="col-md-6 col-sm-12">
	<div class="widget box">
		<div class="widget-header">
			<h4><i class="icon-plus"></i> Update Category</h4>
		</div>
			...
			<form class="form-hroizontal row-border" action="" method="post" >
					...
					<div class="col-md-6 col-sm-12">
						<div class="list-group">
							<li class="list-group-item no-padding">
								<?php 
									$productImg = $category['image'];
									$productImg = ($productImg)? base_url($this->config->item("filemanager")."category/".$productImg):base_url($this->config->item('filemanager').'/products/noproduct.png');
								?>
								<img id="imgprd" src="<?php echo $productImg;?>?<?=Date('U')?>" alt="" width="100%">
							</li>
				...
				<div class="form-group">
					...
					<div class="col-md-9 col-sm-12">
						<input type="text" class="form-control" name="category" value="<?php echo $category['title'];?>" placeholder="Category Title" />
					</div>
				</div>
				<br clear="all" />
