            ...
            <div class="widget-content">
                <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td>Recieving Detail</td>
                            <td><?php echo $enquiry['recieve_detail'];?></td>
                        </tr>
                        <tr>
                            <td>Appliance Image</td>
                            <td><img src='<?php echo site_url($this->config->item('filemanager').'content_image/'.$enquiry['recieve_app_image']);?>' width="150px" /></td>
                        </tr>
                        <tr>
                            <td>OTP</td>
                            <td>
