...
<!--Banner Start-->
            ...
            <div class="quick_contact">
              ...
              <form class="form-horizontal">
                <div class="form-group" style="border-bottom:1px solid #FFF;">
                    ...
                    if($applicances){
                        ?>
                        <select name="appliance_id" class="form-control" onchange="changeAppliance();" style="color:#FFF;">
                ...
                <div class="form-group">
                  <div class="quick_btn">
                    <button type="button" class="btn btn-default btn-skin" style="background-color:#FFF;border:1px solid rgb(3, 0, 22);color:rgb(3, 0, 22);" onclick="addToCart();">Next</button>
                  </div>
                </div>
              </form>
  ...
  <section id="features" style="background-image:none;background-color:#080D22;padding-top:0px;">
    ...
    <div class="container">
      <div class="row">
        <!--<div class="col-md-6 col-sm-12 col-xs-12 text-center" style="border:1px Solid #666;float:left;margin-right:10px;margin-bottom:10px;background-color: rgba(204, 204, 204, 0.1);"> 
        ...
        <div class="icon_box_one" style="float:left;">
          <div class="box_content" style="font-size:1.3em;padding:25px 10px 10px 10px;text-align:justify;margin-left:0px;">
...
function changeAppliance(){
  cat = "<?php echo $cid;?>";
  val = $('select[name=appliance_id]').val();
  if(!val){
...
function createOptions(val){
    ...
    if(val){
		...
		$.get('<?php echo site_url('main/createOptions');?>/brand/'+val, function(responseTxt, statusTxt, xhr){
			if(statusTxt == "success"){
				...
				if(responseTxt){
					...
					$.get('<?php echo site_url('main/createOptions');?>/type/'+val, function(responseTxt, statusTxt, xhr){
						if(statusTxt == "success"){
                            if(!responseTxt){
					...
					$.get('<?php echo site_url('main/createOptions');?>/issue/'+val, function(responseTxt, statusTxt, xhr){
						if(statusTxt == "success"){
              if(!responseTxt){
                //alert('No data available.');
              }else{
