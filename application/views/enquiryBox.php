                  ...
                  <form method="post" action="<?php echo site_url('public/services/search');?>">
                          ...
                          foreach($categories as $cat){
                            ...
                            if($appliances){
                              foreach($appliances as $appliance){
                                echo '<li style="margin:5px 5px 5px 5px;"><a href="'.site_url('main/issueForm/'.$cat['id'].'/'.$appliance['appliance_id']).'"><img src="'.base_url ($this->config->item("template_path").'images/'.$appliance['icon']).'" alt="'.$appliance['appliance_name'].'" /><br />'.$appliance['appliance_name'].'</a></li>';
                              }
                            }
                          }
                          echo '</ul>';
                    ...
                    <div class="booking_summary hidden-lg hidden-md" style="position:fixed;bottom:0px;left:0px;z-index:1005;background-color:#1E1E1E;color:#fff; width:100%;font-size:1.5em;">
                        ...
                        <div class="col-sm-6 col-xs-6 text-right">
                          <a class="btn btn-primary rcorners" href="<?php echo ($totalpaid)?site_url('main/finalCheckout'):'javascript:void(0);';?>" > Next >></a>
                        </div>
                    </div>
                    <div class="form-group col-md-6 col-sm-6 col-xs-12 hidden-sm hidden-xs">
                      <a class="btn btn-primary btn-skin" href="<?php echo ($totalpaid)?site_url('main/finalCheckout'):'javascript:void(0);';?>" > Next >>></a>
                    </div>
                  </form>
                </div>
              </div>
