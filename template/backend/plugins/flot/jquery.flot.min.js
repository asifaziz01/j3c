        ...
        function r(t, r, s, o) {
            ...
            function x(n) {
                e.extend(!0, a, n),
                    ...
                    a.xaxis.color == null && (a.xaxis.color = e.color.parse(a.grid.color).scale("a", 0.22).toString()),
                    a.yaxis.color == null && (a.yaxis.color = e.color.parse(a.grid.color).scale("a", 0.22).toString()),
                    ...
                    a.grid.tickColor == null && (a.grid.tickColor = e.color.parse(a.grid.color).scale("a", 0.22).toString());
                var r,
                    i,
                    s,
                    o = { style: t.css("font-style"), size: Math.round(0.8 * (+t.css("font-size").replace("px", "") || 13)), variant: t.css("font-variant"), weight: t.css("font-weight"), family: t.css("font-family") };
                ...
                a.xaxis.noTicks && a.xaxis.ticks == null && (a.xaxis.ticks = a.xaxis.noTicks),
                    ...
                    a.x2axis && ((a.xaxes[1] = e.extend(!0, {}, a.xaxis, a.x2axis)), (a.xaxes[1].position = "top")),
                    a.y2axis && ((a.yaxes[1] = e.extend(!0, {}, a.yaxis, a.y2axis)), (a.yaxes[1].position = "right")),
            ...
            function M() {
                ...
                var s,
                    ...
                    l = f.length,
                    c = 0;
                for (r = 0; r < t; r++) (s = e.color.parse(f[r % l] || "#666")), r % l == 0 && r && (c >= 0 ? (c < 0.5 ? (c = -c - 0.2) : (c = 0)) : (c = -c)), (o[r] = s.scale("rgb", 1 + c));
                var h = 0,
                    p;
                for (r = 0; r < u.length; ++r) {
                        ...
                        if (!C)
                            for (a = 0; a < h; ++a)
                                (m = y[a]),
                                    (g = S[a]),
                                    g &&
                                        (g.number && m != null && ((m = +m), isNaN(m) ? (m = null) : m == Infinity ? (m = r) : m == -Infinity && (m = -r)),
                                        m == null && (g.required && (C = !0), g.defaultValue != null && (m = g.defaultValue))),
                                    (c[o + a] = m);
                        if (C) for (a = 0; a < h; ++a) (m = c[o + a]), m != null && ((g = S[a]), g.autoscale && (g.x && x(l.xaxis, m, m), g.y && x(l.yaxis, m, m))), (c[o + a] = null);
            ...
            function F(t) {
                ...
                isNaN(+s) || (u += +s),
                    t.direction == "x"
                        ? ((r += u), i == "bottom" ? ((m.bottom += r + o), (t.box = { top: f.height - m.bottom, height: r })) : ((t.box = { top: m.top + o, height: r }), (m.top += r + o)))
                        : ((n += u), i == "left" ? ((t.box = { left: m.left + o, width: n }), (m.left += n + o)) : ((m.right += n + o), (t.box = { left: f.width - m.right, width: n }))),
                    (t.position = i),
                    (t.tickLength = s),
                    (t.box.padding = u),
                    (t.innermost = h);
            ...
            function I(e) {
                e.direction == "x"
                    ? ((e.box.left = m.left - e.labelWidth / 2), (e.box.width = f.width - m.left - m.right + e.labelWidth))
                    : ((e.box.top = m.top - e.labelHeight / 2), (e.box.height = f.height - m.bottom - m.top + e.labelHeight));
            }
            function q() {
            ...
            function z(t) {
                var n = t.options,
                    r;
                typeof n.ticks == "number" && n.ticks > 0 ? (r = n.ticks) : (r = 0.3 * Math.sqrt(t.direction == "x" ? f.width : f.height));
                var s = (t.max - t.min) / r,
                ...
                t.tickGenerator ||
                    ((t.tickGenerator = function (e) {
                        var t = [],
                            ...
                            s = Number.NaN,
                            o;
                        do (o = s), (s = n + r * e.tickSize), t.push(s), ++r;
                        while (s < e.max && s != o);
                        return t;
                    }),
            ...
            function Q() {
                ...
                if (s) {
                    ...
                    for (t = 0; t < s.length; ++t) {
                        ...
                        (u.from = u.axis.p2c(u.from)),
                            ...
                            u.from == u.to || f.from == f.to
                                ? (h.beginPath(), (h.strokeStyle = o.color || a.grid.markingsColor), (h.lineWidth = o.lineWidth || a.grid.markingsLineWidth), h.moveTo(u.from, f.from), h.lineTo(u.to, f.to), h.stroke())
                                : ((h.fillStyle = o.color || a.grid.markingsColor), h.fillRect(u.from, f.to, u.to - u.from, f.from - f.to));
                    }
                }
                ...
                for (var l = 0; l < n.length; ++l) {
                    ...
                    (h.lineWidth = 1),
                        c.direction == "x"
                            ? ((v = 0), d == "full" ? (b = c.position == "top" ? 0 : y) : (b = p.top - m.top + (c.position == "top" ? p.height : 0)))
                            : ((b = 0), d == "full" ? (v = c.position == "left" ? 0 : g) : (v = p.left - m.left + (c.position == "left" ? p.width : 0))),
                        c.innermost ||
                            ((h.strokeStyle = c.options.color),
                            h.beginPath(),
                            (E = S = 0),
                            c.direction == "x" ? (E = g + 1) : (S = y + 1),
                            h.lineWidth == 1 && (c.direction == "x" ? (b = Math.floor(b) + 0.5) : (v = Math.floor(v) + 0.5)),
                            h.moveTo(v, b),
                            h.lineTo(v + E, b + S),
                            h.stroke()),
                    ...
                    for (t = 0; t < c.ticks.length; ++t) {
                        ...
                        c.direction == "x" ? ((v = c.p2c(x)), (S = d == "full" ? -y : d), c.position == "top" && (S = -S)) : ((b = c.p2c(x)), (E = d == "full" ? -g : d), c.position == "left" && (E = -E)),
                            h.lineWidth == 1 && (c.direction == "x" ? (v = Math.floor(v) + 0.5) : (b = Math.floor(b) + 0.5)),
                            h.moveTo(v, b),
                            h.lineTo(v + E, b + S);
                    }
                    h.stroke();
                ...
                r &&
                    ...
                    typeof r == "object" || typeof i == "object"
                        ? (typeof r != "object" && (r = { top: r, right: r, bottom: r, left: r }),
                          typeof i != "object" && (i = { top: i, right: i, bottom: i, left: i }),
                          r.top > 0 && ((h.strokeStyle = i.top), (h.lineWidth = r.top), h.beginPath(), h.moveTo(0 - r.left, 0 - r.top / 2), h.lineTo(g, 0 - r.top / 2), h.stroke()),
                          r.right > 0 && ((h.strokeStyle = i.right), (h.lineWidth = r.right), h.beginPath(), h.moveTo(g + r.right / 2, 0 - r.top), h.lineTo(g + r.right / 2, y), h.stroke()),
                          r.bottom > 0 && ((h.strokeStyle = i.bottom), (h.lineWidth = r.bottom), h.beginPath(), h.moveTo(g + r.right, y + r.bottom / 2), h.lineTo(0, y + r.bottom / 2), h.stroke()),
                          r.left > 0 && ((h.strokeStyle = i.left), (h.lineWidth = r.left), h.beginPath(), h.moveTo(0 - r.left / 2, y + r.bottom), h.lineTo(0 - r.left / 2, 0), h.stroke()))
                        : ((h.lineWidth = r), (h.strokeStyle = a.grid.borderColor), h.strokeRect(-r / 2, -r / 2, g + r, y + r))),
                    h.restore();
            }
            function G() {
                e.each(k(), function (e, t) {
                    ...
                    for (var h = 0; h < t.ticks.length; ++h) {
                        ...
                        t.direction == "x"
                            ? ((l = "center"), (u = m.left + t.p2c(o.v)), t.position == "bottom" ? (a = n.top + n.padding) : ((a = n.top + n.height - n.padding), (c = "bottom")))
                            : ((c = "middle"), (a = m.top + t.p2c(o.v)), t.position == "left" ? ((u = n.left + n.width - n.padding), (l = "right")) : (u = n.left + n.padding)),
            ...
            function tt(e, t, n, r, i, s, o, u, a, f, l, c) {
                ...
                l
                    ? ((b = g = y = !0), (m = !1), (h = n), (p = e), (v = t + r), (d = t + i), p < h && ((w = p), (p = h), (h = w), (m = !0), (g = !1)))
                    : ((m = g = y = !0), (b = !1), (h = e + r), (p = e + i), (d = n), (v = t), v < d && ((w = v), (v = d), (d = w), (b = !0), (y = !1)));
            ...
            function rt(t, n, r, i) {
                ...
                return (o.a = typeof s == "number" ? s : 0.4), o.normalize(), o.toString();
            }
            function it() {
                ...
                if (a.legend.container != null) e(a.legend.container).html(p);
                    ...
                    if (a.legend.backgroundOpacity != 0) {
                        ...
                        var w = y.children();
                        e('<div style="position:absolute;width:' + w.width() + "px;height:" + w.height() + "px;" + d + "background-color:" + b + ';"> </div>')
                            .prependTo(y)
                            .css("opacity", a.legend.backgroundOpacity);
                    }
                }
            }
            function ut(e, t, n) {
            ...
            function gt(t, n) {
                var r = n[0],
                    ...
                    s = t.xaxis,
                    o = t.yaxis,
                    u = typeof t.highlightColor == "string" ? t.highlightColor : e.color.parse(t.color).scale("a", 0.5).toString();
            ...
            function yt(t, n) {
                var r = typeof t.highlightColor == "string" ? t.highlightColor : e.color.parse(t.color).scale("a", 0.5).toString(),
                    i = r,
                ...
                return (
                    n == null &&
                        (this.textContainer == null &&
                            (this.textContainer = e("<div class='flot-text'></div>").css({ position: "absolute", top: 0, left: 0, bottom: 0, right: 0, "font-size": "smaller", color: "#545454" }).insertAfter(this.element)),
                        (n = this.text[t] = e("<div></div>").addClass(t).css({ position: "absolute", top: 0, left: 0, bottom: 0, right: 0 }).appendTo(this.textContainer))),
                    n
                );
            }),
